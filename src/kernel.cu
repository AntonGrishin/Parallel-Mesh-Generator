...
int main()
{
    ...
    fileHeartStl = "D:\\study\\Graphics\\Parallel-Mesh-Generator\\stl\\00_heart_shell.stl";
    //fileHeartStl = "E:/Data/STL/CyberheartModel/00_heart_shell.stl";
    // Folder to store mesh results //
    std::string folderpath = "D:\\study\\Graphics\\Parallel-Mesh-Generator\\stl\\results\\";
    ...
    //float edgeLen = 0.11;
    int nX = 35, nY = 35, nZ = 35;
    float offX = -10.5f, offY = -3.f, offZ = -3.5f;
    float edgeLen = 0.2;
